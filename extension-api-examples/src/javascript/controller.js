...
SYMPHONY.remote.hello().then(function(data) {
    ...
    SYMPHONY.application.register("hello", ["modules", "applications-nav", "ui", "share", "entity"], ["hello:controller", "message:controller"]).then(function(response) {
        ...
        // navService.add("hello-nav", "OpenFin App", "hello:controller");
        ...
        uiService.registerExtension("cashtag", "hello-cashtag", "hello:controller", {label: "OpenFin IAB"});
        ...
        helloControllerService.implement({
            ...
            select: function(id) {
                ...
                modulesService.show("hello", {title: "OpenFin App"}, "hello:controller", "https://localhost:4000/app.html", {
            ...
            link: function(type, articleId) {
                if(type == "article") {
                    var moduleTitle = "OpenFin App: " + articleId;
